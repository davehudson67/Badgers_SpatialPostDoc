# =============================================================================
# WOODCHESTER V7M-C - CENTERED MOVEMENT-ONLY MODEL
#
# Purpose
...
# Centered S nodes retain NIMBLE's default local samplers for this benchmark.
# The key test is whether removing the recursive deterministic eps -> S path
# reduces per-iteration recalculation cost.
...
result_file <- sprintf(
  "results/RD_SCR_V7MC_CENTERED_MOVEMENT_ONLY_1285_CHAIN_%d%s.rds",
  CHAIN_ID,RESULT_TAG
)
...
saveRDS(
  list(
    ...
    settings=list(
      model="V7MC_centered_movement_only_modular_source",
      ...
      ac_sampler="NIMBLE_default_local",
