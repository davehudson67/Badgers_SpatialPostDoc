# =============================================================================
# WOODCHESTER V7MC-MHMM v4 - PI-CONSTANT FIX
#
# Purpose
...
cat("\n============================================================\n")
cat("WOODCHESTER V7MC-MHMM v4: AF_SLICE AC + MARGINALIZED HMM\n")
cat("============================================================\n")
...
result_file <- sprintf(
  "results/RD_SCR_V7MCMHMMv4_PI_FIX_MARGINAL_HMM_1285_CHAIN_%d%s.rds",
  CHAIN_ID,RESULT_TAG
)
...
saveRDS(
  list(
    ...
    settings=list(
      model="V7MCMHMMv4_pi_constant_fix_marginalized_two_state_movement_HMM",
