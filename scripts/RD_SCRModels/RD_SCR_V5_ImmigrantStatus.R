# =============================================================================
# WOODCHESTER SPATIAL CMR V5 DEVELOPMENT TEST (OPTIMIZED LATENT IMMIGRATION)
...
cat("\n============================================================\n")
cat("V5 DYNAMIC NORMALIZED MOVEMENT + LATENT IMMIGRATION MODEL\n")
cat("800 badgers | Student-t3 | sex effects + latent immigrant effects on movement/survival\n")
cat("============================================================\n\n")
...
saveRDS(list(samples=samples_V3,runtime=runtime_V3,build_time=build_time_V3,
        ...
        paste0("results/RD_SCR_V5_t",MOVE_DF,
...
if(length(adult_entry_idx)){
  ...
  saveRDS(list(individual=immigrant_posterior,sexratio=sexratio_summary),
          paste0("results/RD_SCR_V5_immigrant_summary_",nind,"_badgers.rds"))
} else {
  immigrant_posterior <- tibble()
  sexratio_summary <- tibble()
