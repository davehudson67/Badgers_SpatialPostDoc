# =============================================================================
# V9FINAL V7b KNOWN-AGE AGE SENSITIVITY — SAFE FULL SUMMARY WRAPPER
#
...
base_file <- "scripts/ModularFitting/Woodchester_V9FINAL_V7bM_knownage_age_sensitivity.R"
...
if(is.null(err)){
  ...
  cat("\n============================================================\n")
  cat("V9FINAL V7b KNOWN-AGE AGE SENSITIVITY — SAFE SUMMARY\n")
  cat("============================================================\n")
  ...
  out <- paste0("results/V9FINAL_V7bM_knownage_age_",RESULT_TAG,".rds")
  csv <- paste0("results/V9FINAL_V7bM_knownage_age_",RESULT_TAG,"_summary.csv")
  saveRDS(list(model="V9FINAL V7b known-age baseline vs chronological-age adjustment",
               ...
               settings=list(age_center=AGE_CENTER,age_at_risk="Q1 birth assumption; outcome-year age + (quarter-1)/4",
                             n_pairs=nrow(pair_index),N_PROP=N_PROP,N_KEEP=N_KEEP,development_only=FALSE,
