# =============================================================================
# V7MC-MHMM v6 FINAL30K COMBINE + EXACT POSTERIOR STATE AGREEMENT
# =============================================================================
library(tidyverse)
library(coda)
...
saveRDS(list(global_diagnostics=global_diag,per_chain=per_chain,pairwise=pairwise,
        ...
        "results/V7MCMHMMv6_FINAL30K_diagnostics.rds")
cat("\nSaved: results/V7MCMHMMv6_FINAL30K_diagnostics.rds\n")
